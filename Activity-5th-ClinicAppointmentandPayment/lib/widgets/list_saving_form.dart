...
class _ListSavingFormState extends State<ListSavingForm> {
  ...
  final Map<String, double> _services = {
    'General Consultation': 500.0,
    'Dental Checkup': 800.0,
    'Laboratory Tests': 1500.0,
    'Physical Therapy Session': 1200.0,
  };
  ...
  void _submitBooking() {
    if (_formKey.currentState!.validate()) {
      ...
      setState(() {});
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Appointment saved locally')));
    }
  }
    ...
    return Card(
      ...
      child: Padding(
        ...
        child:
          ...
          const Text('Appointment & Payment (Save to Local List)',
          ...
          Form(
            ...
            child: Column(children: [
              ...
              DropdownButtonFormField<String>(
                ...
                isExpanded: true, // avoid RenderFlex overflow in narrow layouts
                items: _services.keys
                    .map((s) => DropdownMenuItem(
                        value: s,
                        child: Text(
                          '$s — ₱${_services[s]!.toStringAsFixed(0)}',
              ...
              ElevatedButton(
                  ...
                  child: const Text('Save Appointment Locally')),
            ]),
          ),
          const SizedBox(height: 12),
          const Text('Saved Appointments:',
